...
#line 211 "Parser.hpp"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_programa = 23,                         // programa
        S_declaraciones = 24,                    // declaraciones
        S_declaracion = 25,                      // declaracion
        S_tipo = 26,                             // tipo
        S_lista_var = 27,                        // lista_var
        S_sentencias = 28,                       // sentencias
        S_sentencia = 29,                        // sentencia
        S_expresion = 30                         // expresion
      };
    };
